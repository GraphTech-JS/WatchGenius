...
exports.WatchCardSkeleton = function () {
    return (react_1["default"].createElement("div", { className: WatchCard_module_css_1["default"].watchCard + " border border-[rgba(23,20,20,0.15)] bg-white" },
        react_1["default"].createElement("div", { className: 'flex justify-between items-center' },
            react_1["default"].createElement(react_loading_skeleton_1["default"], { height: 27, width: 27, borderRadius: 5 }),
        ...
        react_1["default"].createElement("div", { className: 'relative h-[111px] md:h-[124px] xl:h-[123px] w-full' },
            react_1["default"].createElement(react_loading_skeleton_1["default"], { className: WatchCard_module_css_1["default"].skeletonImage, style: {
                    position: 'absolute',
                    top: 0,
                    bottom: 0
                } })),
