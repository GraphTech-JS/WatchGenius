...
export const HeroChartItem: React.FC<HeroChartItemProps> = ({
  ...
  return (
    <div className="relative flex flex-col items-center px-2.5 lg:px-2.5 pt-7.5 pb-1.5 lg:py-3 w-[350px] lg:w-[210px] h-full rounded-[10px] gap-0 md:gap-3 shrink-0">
      ...
      <LineChart data={data} variant={variant} height={chartHeight} id={id} />
    </div>
  );
};
